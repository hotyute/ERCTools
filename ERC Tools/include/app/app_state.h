...
inline constexpr UINT WM_APP_WEATHER_READY = WM_APP + 6;
...
extern const wchar_t kIrelandBoundarySourceUrl[];
...
extern std::atomic_bool g_weatherSystemsFetchInProgress;
